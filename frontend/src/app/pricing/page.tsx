      ...
      <section className="py-20 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <h1 className="text-5xl font-bold mb-6">
            {isJa ? '料金体系' : 'Simple, Transparent'} <span className="text-gradient">{isJa ? '' : 'Pricing'}</span>
          </h1>
          <p className="text-xl text-text-secondary mb-8">
            {isJa ? '利用分だけお支払い。隐藏料金一切なし。' : 'Pay only for what you use. No hidden fees, no long-term commitments.'}
          </p>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="card">
              ...
              <div className="text-center mb-6">
                <span className="text-4xl font-bold text-accent">{isJa ? 'お問い合わせ' : 'Custom'}</span>
              </div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-2 text-sm">
                  <Check className="w-4 h-4 text-success" />
